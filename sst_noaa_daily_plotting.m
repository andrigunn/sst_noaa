...
text(0.01,0.9,['Viðmið: ',num2str(baseline_period.Year(1)),' - ',num2str(baseline_period.Year(2))],...
    'Units','normalized','HorizontalAlignment','left',...
    'VerticalAlignment','bottom','FontSize',12,'FontWeight','bold',...
    'Interpreter','none');
...
for i = 1:length(fnames)
    ...
    text_lower_right = ['Gögn: SST-NOAA-OISST.v2.highres - Viðmið: ',num2str(baseline_period.Year(1)),' - ',num2str(baseline_period.Year(2))];
